...
def copy_script_files(dir_path: str, service_name: str, scripts_required):
...
def copy_environment_vars(dir_path, environment_vars, service_name):
    file_to_path = '%s/dev_env/apps/%s/bin/' % (dir_path, service_name)  
