...
def setup_service(service, dir :str, scripts_required, env_var_substitutions):
    logger.info('Installing %s' % (service['name']))
    orchestrate_service_setup(service, dir, scripts_required, env_var_substitutions)
    logger.info('Finished installing %s' % (service['name']))

def orchestrate_service_setup(service, dir :str, scripts_required, env_var_substitutions):
